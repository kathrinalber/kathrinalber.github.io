...
excerpt: "In this project, I analyzed trends in thunderstorm activity over the Congo Basin since 1983. To detect thunderstorms, I used two different methods, the Gálvez-Davison Index (GDI) and GridSat-B1 satellite cold cloud fraction (CCF). The GDI is a thermodynamic index developed at the Weather Prediction Center, aiming to forecast convection in the tropics more accurately. The GridSat-B1 CCF is derived by calculating the fraction of pixels with brightness temperatures between -50°C and -70°C from the GridSat-B1 satellite dataset. It can be utilized to detect cold cloud tops and to quantify thunderstorm spatial extent and intensity since deep tropical convection is characterized by low brightness temperatures.  <br/><img src='/images/Schematic.pdf'>"
